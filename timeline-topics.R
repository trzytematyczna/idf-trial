...
rds_dir <- "./results/twitter-timeline/rds" #"./test/"
model_dir<-"./results/twitter-timeline/" #"./test"
res_dir<-"./results/twitter-timeline/topics/"
...
exp_name<-paste0(data_name,"-alpha-",alpha,"-ngram-",ngram, "-file_",m,"-timeline")

dtm_file<-paste0(rds_dir,"/dtm-",data_name,"-ngram-",ngram, "-file_",m,"-timeline",".Rds")
original_tf_file <- paste0(rds_dir,"/originaltf-",data_name,"-ngram-",ngram, "-file_",m,"-timeline",".Rds")
